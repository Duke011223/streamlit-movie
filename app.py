...
def load_data():
    try:
        df = pd.read_csv("C:\\Users\\User\\Documents\\Visual Studio 2022\\Code Snippets\\Python\\My Code Snippets\\movie_data.csv", encoding='cp949')
...
def save_users(users):
    pd.DataFrame(users).to_csv("C:\\Users\\User\\Documents\\Visual Studio 2022\\Code Snippets\\Python\\My Code Snippets\\movie_users.csv", index=False, encoding='cp949')

def load_users():
    path = "C:\\Users\\User\\Documents\\Visual Studio 2022\\Code Snippets\\Python\\My Code Snippets\\movie_users.csv"
    if os.path.exists(path):
        return pd.read_csv(path, encoding='cp949').to_dict('records')
    return []

def save_ratings(ratings):
    pd.DataFrame(ratings).to_csv("C:\\Users\\User\\Documents\\Visual Studio 2022\\Code Snippets\\Python\\My Code Snippets\\movie_ratings.csv", index=False, encoding='cp949')

def load_ratings():
    path = "C:\\Users\\User\\Documents\\Visual Studio 2022\\Code Snippets\\Python\\My Code Snippets\\movie_ratings.csv"
    if os.path.exists(path):
        return pd.read_csv(path, encoding='cp949').to_dict('records')
    return []
